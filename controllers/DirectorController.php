<?php
    ...
    function listDirectors(){
        ...
        foreach ($directorList as $directorItem){
            $directorObjet = new Director($directorItem->getId_director(), $directorItem->getName(), 
            $directorItem->getSurname(), $directorItem->getBithdate(), $directorItem->getNationality()) ;
    ...
    function deleteDirector($directorId){
        $deleteDirector = new Director($directorId, null) ;
